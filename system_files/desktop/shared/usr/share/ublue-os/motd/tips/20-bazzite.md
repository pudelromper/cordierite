*Installing a Windows app that isn't on Steam?* Lutris is pre-installed and recommended for better handling of wine prefixes~[View guide](https://docs.bazzite.gg/Gaming/)
...
*Want to control your device from your phone?* The KDE Connect app functions with all Cordierite images~[More info](https://kdeconnect.kde.org/)
